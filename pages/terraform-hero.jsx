  ...
  useEffect(() => {
    ...
    let lessons = [
      ...
      },
      {
        title: "Outputs",
        content:
          "<div class='prose prose-invert'><p class='mb-4'>Les outputs permettent d'afficher des informations importantes après l'application de votre configuration.</p><div class='bg-dracula-selection border-l-4 border-dracula-cyan p-4 rounded my-6'><strong class='text-dracula-cyan'>🎯 Objectif:</strong><p>Créer des outputs pour afficher les informations de l'instance EC2.</p></div><p>Créez des outputs pour:</p><ul class='list-disc pl-6 mb-4'><li>L'ID de l'instance</li><li>L'adresse IP publique</li><li>Le nom DNS public</li></ul></div>",
        initialCode: "# Définissez vos outputs ici\n",
        solution:
          'output "instance_id" {\n  value = aws_instance.example.id\n}\n\noutput "public_ip" {\n  value = aws_instance.example.public_ip\n}\n\noutput "public_dns" {\n  value = aws_instance.example.public_dns\n}',
        hint: 'Utilisez la syntaxe output "nom" { value = resource.id.attribut }',
        validation: "outputs"
      },
      {
        title: "Data Sources",
